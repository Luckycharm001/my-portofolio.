      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <Card key={index} className="group overflow-hidden hover:shadow-xl transition-all duration-300 border-0 shadow-md hover:scale-105">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className="flex-1 border-gray-300 hover:border-blue-600 hover:bg-blue-50"
                    asChild
                  >
